...
Synack Red Team triage tool with two modes: visual screenshot deduplication via Perceptual Hashing, and differential HTTP access-control testing for IDOR/BOLA detection. All processing is local — no external API calls, no cloud uploads.
